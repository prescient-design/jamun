...
def apply_layer_rot(layer):
    ...
    edge_sh = o3.spherical_harmonics(layer.irreps_sh, edge_vec, True, normalization="component")
    ...
    out_1 = layer(node_attr @ D_node_attr.T, edge_index, edge_attr, edge_sh @ D_edge_sh.T)
...
def test_equivariant_mlp():
    ...
    layer = EquivariantMLP(irreps, irreps, [irreps_hidden, irreps_hidden], norm_layer=LayerNorm)
