...
def main():
    ...
    parser.add_argument(
        "--data-dir", default="/data2/sules/fake_enhanced_data/ALA_ALA", help="Directory containing trajectory files"
    )
    parser.add_argument("--output", default="scratch/grid_code_histogram.png", help="Output path for histogram plot")
