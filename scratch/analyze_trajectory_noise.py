...
def load_trajectories(traj_dir: str, topology_file: str, max_files: int | None = None) -> list[md.Trajectory]:
    """
...
def analyze_trajectories(
    ...
    time_point_filter: list[tuple[int, int]] | None = None,
...
def main():
    ...
    parser.add_argument("--noise_magnitude", type=float, default=0.04, help="Noise magnitude (standard deviation)")
    parser.add_argument("--max_files", type=int, default=50, help="Maximum number of trajectory files to load")
    parser.add_argument(
        "--time_filter",
        type=str,
        default=None,
    ...
    parser.add_argument("--output", type=str, default="trajectory_noise_analysis.png", help="Output plot filename")
    ...
    original_norms, noisy_norms = analyze_trajectories(trajectories, args.noise_magnitude, time_point_filter)
