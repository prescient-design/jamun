...
def compare_with_different_parameters():
    ...
    for i, params in enumerate(test_cases):
        ...
        py_logger.info(f"Parameters: subsample={params['subsample']}, total_lag_time={params['total_lag_time']}, lag_subsample_rate={params['lag_subsample_rate']}")
        ...
        try:
            ...
            if datasets:
                ...
                if hasattr(sample, 'hidden_state') and sample.hidden_state:
                    ...
                    py_logger.info(f"  -> No hidden state")
            else:
                py_logger.warning(f"  -> No datasets found")
