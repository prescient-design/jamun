...
from jamun.utils import find_checkpoint, mean_center_f, unsqueeze_trailing
...
def return_wrapped_denoiser(
    ...
    checkpoint_path = find_checkpoint(
        wandb_train_run_path=wandb_run_path, checkpoint_dir=checkpoint_dir, checkpoint_type=checkpoint_type
    )
    ...
    py_logger.info("✓ Using denoiser's own normalization parameters:")
