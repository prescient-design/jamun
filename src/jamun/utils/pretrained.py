...
def load_pretrained_model_from_checkpoint(
    ...
    try:
        ...
        if wandb_run_path:
            checkpoint_path = find_checkpoint(wandb_train_run_path=wandb_run_path, checkpoint_type=checkpoint_type)
...
def extract_module_from_model(model: pl.LightningModule, module_path: str) -> nn.Module | None:
    """
...
def check_model_compatibility(
    ...
    wandb_run_path: str | None = None,
    checkpoint_type: str = "best_so_far",
    expected_model_class: type | None = None,
) -> dict[str, Any]:
    """
    ...
    try:
        ...
        if model is None:
            return {"loadable": False, "model_class": None, "error": "Failed to load model from checkpoint"}
        ...
        return {"loadable": False, "model_class": None, "error": str(e)}
