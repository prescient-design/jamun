...
def parse_args():
    ...
    parser.add_argument('--input', '-i', 
                       required=True,
                       help='Input trajectory file (PDB format)')
    
    parser.add_argument('--output', '-o',
                       default='minimized.pdb',
                       help='Output minimized trajectory file (PDB format)')
    
    parser.add_argument('--n-frames', '-n',
                       type=int,
                       default=None,
    ...
    parser.add_argument('--max-iterations', 
                       type=int,
                       default=10,
                       help='Maximum number of minimization iterations (default: 10)')
    ...
    parser.add_argument('--forcefield',
                       ...
                       help='Force field to use (default: amber14-all.xml)')
...
def minimize_trajectory(args):
    ...
    for positions in tqdm.tqdm(all_positions,
                               total=len(all_positions),
                               desc="Minimizing structures"):
        # Add hydrogens
        ...
        # Clean up
        del modeller, simulation, system, integrator
